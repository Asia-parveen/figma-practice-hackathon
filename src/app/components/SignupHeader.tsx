  ...
  return (
    <>
      <div className="flex flex-wrap items-center h-auto sm:h-[5rem] border-b-2 px-4 sm:px-8 lg:px-16 py-2">
        ...
        <ul className="flex-grow flex flex-wrap justify-center sm:justify-center space-x-4 sm:space-x-6 text-xs sm:text-sm font-medium mb-2 sm:mb-0 opacity-[0.6]">
          ...
          <li className="lg:text-[16px]">
            <Link href="/signup" className="hover:text-gray-700 border-b-2">
              Sign Up
            </Link>
          </li>
          <li className="lg:text-[16px]">
            <Link href="/login" className="hover:text-gray-700 border-b-2">
              Login
            </Link>
          </li>
          <li className="lg:text-[16px]">
