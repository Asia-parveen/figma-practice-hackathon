...
const WishBotCard: React.FC<WishBotCardProps> = ({ imageSrc, discount, title, price, stars }) => {
  return (
    <div className="relative group  rounded-lg mx-auto w-[270px] h-[400px] flex flex-col">
      {/* Upper Section with Light Gray Background */}
      <div className="relative bg-[#F5F5F5] h-[400px] w-full flex items-center justify-center">
        {/* Discount Badge */}
        ...
        {/* Add to Cart Button */}
        <button className="absolute bottom-0 w-full bg-black text-white px-4 py-2  hover:bg-[#DB4444] ">
          Add to Cart
        </button>
      </div>
